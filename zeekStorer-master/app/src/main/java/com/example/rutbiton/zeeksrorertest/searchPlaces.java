...
//            Log.d("Jj", "Error processing Places API URL", e);
//            return resultList;
//        } catch (IOException e) {
//            Log.d("jj", "Error connecting to Places API", e);
//            return resultList;
//        } finally {
//            if (conn != null) {
//                conn.disconnect();
...
//            Log.d("jj", "Cannot process JSON results", e);
//        }
//
       return resultList;
    }
    ...
    public void search(double longitude, double latitude) throws IOException {
        ...
        Log.d("gg", "latitude+" + latitude + " longitude" + longitude);
